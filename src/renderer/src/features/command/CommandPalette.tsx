      ...
      <div className="relative w-full max-w-lg mx-4 bg-[var(--bg-surface)] border border-[var(--bg-active)] rounded-xl shadow-2xl overflow-hidden fade-in">
        ...
        {contextPaperId && (
          <div className="px-4 pb-2">
            <div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-[var(--accent-color)]/10 border border-[var(--accent-color)]/20 text-[11px] text-[var(--accent-color)]">
              <FileText size={10} />
          ...
          <div className="py-2">
            ...
            {paperHits.map((hit, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[12px] text-[var(--text-bright)] font-medium truncate">{hit.paper.title}</p>
          ...
          <div className="px-4 py-4 space-y-1.5">
            {[
              ...
              >
                ...
                <span className="text-[12px] text-[var(--text-muted)] group-hover:text-[var(--text-secondary)] transition-colors">{hint}</span>
              </button>
            ))}
          </div>
        )}
