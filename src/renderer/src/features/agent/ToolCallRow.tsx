...
export function ToolCallRow({ toolCall, msgId, onToggle }: ToolCallRowProps) {
  ...
  return (
    <div className="my-1 rounded-[6px] border border-[var(--bg-active)] bg-[var(--bg-surface)] overflow-hidden">
      <button
        className="w-full flex items-center gap-2 px-3 py-1.5 text-[13.5px] hover:bg-[var(--bg-elevated)] transition-colors"
      ...
      {toolCall.expanded && (
        <div className="border-t border-[var(--bg-active)]">
          ...
          <div className="px-3 py-2">
            <p className="text-[12.5px] text-[var(--text-muted)] uppercase tracking-wider mb-1">
              {t('agent.tool.input')}
            </p>
            <pre className="text-[13.5px] text-[var(--text-secondary)] font-mono whitespace-pre-wrap break-all leading-relaxed">
          ...
          {hasResult && (
            <div className="px-3 py-2 border-t border-[var(--bg-elevated)]">
              ...
              <pre className="text-[13.5px] text-[var(--status-read)]/80 font-mono whitespace-pre-wrap break-all leading-relaxed">
