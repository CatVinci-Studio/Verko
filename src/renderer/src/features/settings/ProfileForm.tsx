...
export function ProfileForm() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h3 className="text-[13px] font-semibold text-[var(--text-primary)] mb-0.5">AI Profiles</h3>
        <p className="text-[12px] text-[var(--text-muted)]">Select a provider and save your API key.</p>
      </div>
      ...
      {/* Key input for selected profile */}
      {selectedProfile && (
