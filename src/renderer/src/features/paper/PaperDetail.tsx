...
export function PaperDetail() {
  ...
  if (!selectedId) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-2">
        ...
        <p className="text-[15.5px] text-[var(--text-muted)]">Select a paper to view</p>
      </div>
    )
  }
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-full">
        <span className="text-[14.5px] text-[var(--text-muted)]">{t('common.loading')}</span>
      </div>
    )
  }
  ...
  if (error || !paper) {
    return (
      <div className="flex items-center justify-center h-full">
        <span className="text-[14.5px] text-[var(--danger)]">Failed to load paper</span>
      </div>
    )
  }
      ...
      <div className="px-4 pt-4 pb-3 border-b border-[var(--bg-active)] shrink-0">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          {paper.venue && (
            <>
              <span className="text-[var(--bg-active)]">·</span>
              <span className="text-[14.5px] text-[var(--text-muted)] truncate max-w-[120px]">{paper.venue}</span>
            </>
          )}
        </div>
