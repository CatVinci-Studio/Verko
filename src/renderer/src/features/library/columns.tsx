          ...
          <div className="flex items-center gap-1.5 min-w-0 w-full">
            ...
            <div className="flex-1 min-w-0">
              <EditableTextCell
                ...
                display={
                  <span className="text-[15.5px] truncate font-medium text-[var(--text-bright)]">
                    {p.title || (
      ...
      cell: ({ row, table }) => {
        ...
        return (
          <EditableTextCell
            ...
            display={
              <span className="text-[14.5px] text-[var(--text-secondary)] truncate">
      ...
      cell: ({ row, table }) => {
        ...
        return (
          <EditableTextCell
            ...
            inputType="number"
            display={
              <span className="text-[14.5px] text-[var(--text-secondary)] tabular-nums">
                {formatYear(p.year)}
              </span>
            }
            onSave={(next) => {
            ...
            display={
              p.tags.length > 0 ? (
                <div className="flex items-center gap-1 overflow-hidden">
                  ...
                  {p.tags.length > 2 && (
                    <span className="text-[12.5px] text-[var(--text-muted)] shrink-0">
                      +{p.tags.length - 2}
                    </span>
                  )}
                </div>
